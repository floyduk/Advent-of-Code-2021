...
# Note: This is purely for testing and interest. Nothing about d13p1 challenge requires 
# us to plot points on a grid.
...
for r in rules:
    ...
    plot_and_display_the_grid()
    print(f"Solution: {len(points)}")
    exit()                                      # For part 1 we exit after the first rule is processed
